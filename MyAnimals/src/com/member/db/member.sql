...
INSERT INTO MEMBER VALUES('GUEST', '1234', '문재필', '920325', 'zerg_kid@gmail.com', 'M', '경기도 수원시 권선구 탑동', 'USER', 'N', SYSDATE, '010-1234-5678', '봉사자')
INSERT INTO MEMBER VALUES('CENTER', '1234', '정은주', '951010', 'JOO@naver.com', 'F', '경기도 수원시 권선구 권선동', 'CENTER', 'N', SYSDATE, '010-9876-5432', '센터장')

 

SELECT * FROM CENTER;
UPDATE CENTER SET MEMBER_ID = 'CENTER' WHERE CENTER_SEQ = 2;
